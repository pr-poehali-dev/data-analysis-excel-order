            ...
            <Tabs defaultValue="forecast" className="space-y-4">
              ...
              <TabsContent value="upload" className="space-y-4">
                <Card>
                  ...
                  <CardContent>
                    <div 
                      className="border-2 border-dashed rounded-xl p-12 text-center hover:border-primary transition-colors cursor-pointer"
                      onClick={() => setSelectedFile('example_file.xlsx')}
                    >
                      <div className="flex flex-col items-center gap-4">
                        ...
                        <div>
                          <p className="font-medium text-lg mb-1">Перетащите файлы сюда</p>
                      ...
                      <div className="mt-4 p-4 rounded-lg border bg-muted/30 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">2.4 MB • Загружен</p>
                          </div>
                        </div>
                        <Button size="sm" className="gradient-primary">
